    ...
    // $result->msg contains a user-facing error description
            ...
            <div class="fwi-card">
                ...
                <ul class="fwi-about-list">
                    ...
                    <li>Background retry attempts (see the <em>Webhook Failure Mode</em> setting) appear as their own entries, labelled with the attempt number appended to the webhook label — e.g. <em>CRM (retry 2/6)</em> — so a failed delivery and its retries can be traced together by label and timestamp.</li>
